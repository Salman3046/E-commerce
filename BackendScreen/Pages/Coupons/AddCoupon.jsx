...
import { addCoupon } from "../../../Services/Actions/couponAction";
...
const AddCoupon = () => {
  ...
  const submitInventory = (ev) => {
    ...
    if (!inventory.coupon_name)
      ...
      dispatch(addCoupon(inventory, userDataFromLocal.token));
      setInventory({
        coupon_name: "",
        coupon_type: "",
        percentage: "",
      ...
      toaster({ type: "success", content: "Coupon add successfully" });
              ...
              <Box className="grid grid-cols-0 gap-6">
                <Box className="col-span-12 sm:col-span-3">
                  ...
                  <InputField
                    ...
                    onChange={onChangeHandler}
                    onKeyPress={(e) => inputRestrictions({ evt: e, length: 7 })}
                  />
                </Box>
              </Box>
            </Box>
